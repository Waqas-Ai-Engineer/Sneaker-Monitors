# --------------------- WEBHOOK URL ---------------------
WEBHOOK = "https://discord.com/api/webhooks/1550586237759262832/Dz-QCdY6DdVdXPlKHAwgwAL02QDXfJvddqYcaq1K5DbhmafyLaqiG_tr9_9FtSRhZknv"

# --------------------- SHOPIFY URL ---------------------
# Ensure the URL is one that contains products.json (e.g. https://www.hanon-shop.com/collections/whats-new/products.json)
URL = "https://www.allbirds.com/products.json?utm_source=chatgpt.com"
